...
export const command: string = 'get <email> <password>';
export const desc: string = 'Get user details for email address <email>';
...
export const builder: CommandBuilder<Options, Options> = (yargs) =>
  yargs
    ...
    .positional('email', { type: 'string', demandOption: true, describe: 'The email address of the user to get' })
    .positional('password', { type: 'string', demandOption: true, describe: 'The password of the user to get' })
    .example('$0 get test@test.com password', '');
...
export const handler = (argv: Arguments<Options>): void => {
  ...
  thunder.getUser(email, password, (err: Error, statusCode: any, result: any) => {
    if (err) {
